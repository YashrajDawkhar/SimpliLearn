...
const routes: Routes = [
  ...
  },
  {
    path: 'Python',
    loadChildren: () =>
      import('./python/python.module').then((m) => m.PythonModule),
  },
  {
    path: 'Cpp',
    loadChildren: () => import('./cpp/cpp.module').then((m) => m.CppModule),
  },
  {
    path: 'Vscode',
    loadChildren: () =>
      import('./vscode/vscode.module').then((m) => m.VscodeModule),
  },
  {
    path: 'Eclipse',
    loadChildren: () =>
      import('./eclipse/eclipse.module').then((m) => m.EclipseModule),
  },
  {
    path: 'Home',
